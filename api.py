"""QAP-107 Модуль 24 - задание 24.7.2"""
...
class PetFriends:
    ...
    def get_list_of_pets(self, auth_key: json, my_filter: str = "") -> json:
        ...
        res = requests.get(self.base_url + 'api/pets', headers=headers, params=my_filter)
        status = res.status_code
        result = ""
        try:
            result = res.json()
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str,
        ...
        """Метод отправляет на сервер данные о добавляемом питомце + фото и возвращает статус
